...
:::{.incremental}
1. Dans la console, installer les _packages_ `R` [`lintr`](https://github.com/r-lib/lintr) et [`styler`](https://github.com/r-lib/styler).
...
- [script.R](https://github.com/cbobinec/formation-bonnes-pratiques-git-R/blob/main/R/checkpoints/application1/script.R)
