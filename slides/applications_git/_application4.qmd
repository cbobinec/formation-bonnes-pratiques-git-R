...
2. Le mainteneur crée un dépôt sur `Gitlab`. Il/Elle donne des droits au(x) développeur(s) du projet
3. Créer une copie locale (clone) du projet depuis AUS et `RStudio`
